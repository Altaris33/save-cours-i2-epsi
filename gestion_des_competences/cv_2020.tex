...
% profile picture
\cvprofilepic{images/epsi_logo.jpg}
...
\addtobacksidebar{
	...
	\aboutme{
		Passionné d'informatique et de sciences en général, je suis en quête de challenge
	...
	\begin{memberships}
		\membership[4em]{images/epsi_logo.jpg}{PandaScience.net}
		\membership[4em]{images/epsi_logo.jpg}{Some longer text spanning over more than
			only one line}
	\end{memberships}
}
