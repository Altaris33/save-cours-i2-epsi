...
class QTable(AbstractModel):
    """
        Class for the qtable which stores as a pair the state and actions of the agent inside the labyrinth  
    """
    ...
    def __init__(self, game, **kwargs):
        """ 
        Parameters: class Labyrinth game: Maze game object
    ...
    def train(self, stop_at_convergence=False, **kwargs):
        """ T
            Parameters: stop_at_convergence: stop training as soon as convergence is reached
            Hyperparameters:
            ...
            Returns int, datetime: number of training episodes, total time spent
        """
    ...
    def q(self, state):
        """ 
            Gets: q values for all actions for a certain state. 
        """
    ...
    def predict(self, state):
        """ 
            ...
            Parameters np.ndarray state: game state
            Returns: int: selected action
        """
        q = self.q(state)   
